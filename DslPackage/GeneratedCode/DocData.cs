...
namespace Company.FinalVersionSoSa
{
	...
	/// </summary>
	internal partial class FinalVersionSoSaDocData : FinalVersionSoSaDocDataBase
	{
		/// <summary>
		/// Constructs a new FinalVersionSoSaDocData.
		/// </summary>
		public FinalVersionSoSaDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a FinalVersionSoSa document in memory.
	/// </summary>
	internal abstract partial class FinalVersionSoSaDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new FinalVersionSoSaDocDataBase.
		/// </summary>
		protected FinalVersionSoSaDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Company.FinalVersionSoSa.FinalVersionSoSaDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Company.FinalVersionSoSa.FinalVersionSoSaDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Company.FinalVersionSoSa.FinalVersionSoSaDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Company.FinalVersionSoSa.FinalVersionSoSaDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Company.FinalVersionSoSa.SoSa modelRoot = null;
			...
			global::Company.FinalVersionSoSa.FinalVersionSoSaDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Company.FinalVersionSoSa.FinalVersionSoSaSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Company.FinalVersionSoSa.FinalVersionSoSaDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Company.FinalVersionSoSa.FinalVersionSoSaDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Company.FinalVersionSoSa.SoSa modelRoot = (global::Company.FinalVersionSoSa.SoSa)this.RootElement;
			...
			{
				global::Company.FinalVersionSoSa.FinalVersionSoSaDiagram diagram = diagrams[0] as global::Company.FinalVersionSoSa.FinalVersionSoSaDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Company.FinalVersionSoSa.FinalVersionSoSaSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Company.FinalVersionSoSa.FinalVersionSoSaSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Company.FinalVersionSoSa.FinalVersionSoSaDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Company.FinalVersionSoSa.FinalVersionSoSaSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Company.FinalVersionSoSa.SoSa modelRoot = this.RootElement as global::Company.FinalVersionSoSa.SoSa;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Company.FinalVersionSoSa.FinalVersionSoSaSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
