...
namespace Company.FinalVersionSoSa
{
	...
	/// </summary>
	internal partial class FinalVersionSoSaDocView : FinalVersionSoSaDocViewBase
	{
		/// <summary>
		/// Constructs a new FinalVersionSoSaDocView.
		/// </summary>
		public FinalVersionSoSaDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class FinalVersionSoSaDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new FinalVersionSoSaDocView.
		/// </summary>
		protected FinalVersionSoSaDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			FinalVersionSoSaDocDataBase docData = this.DocData as FinalVersionSoSaDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for FinalVersionSoSaDocViewBase should be an FinalVersionSoSaDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.FinalVersionSoSa.FinalVersionSoSaDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.FinalVersionSoSa.FinalVersionSoSaDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.FinalVersionSoSa.FinalVersionSoSaToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.FinalVersionSoSa.FinalVersionSoSaToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.FinalVersionSoSaDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.FinalVersionSoSa.FinalVersionSoSaHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.FinalVersionSoSa.FinalVersionSoSaHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.FinalVersionSoSa.FinalVersionSoSaHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
