...
namespace Company.FinalVersionSoSa
{
	...
	/// </summary>
	internal partial class FinalVersionSoSaCommandSet : FinalVersionSoSaCommandSetBase
	{
		/// <summary>
		/// Constructs a new FinalVersionSoSaCommandSet.
		/// </summary>
		public FinalVersionSoSaCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class FinalVersionSoSaCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new FinalVersionSoSaCommandSetBase.
		/// </summary>
		protected FinalVersionSoSaCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewFinalVersionSoSaExplorerCommand,
				typeof(FinalVersionSoSaEditorFactory).GUID);
		...
		{
			FinalVersionSoSaExplorerToolWindow explorer = this.FinalVersionSoSaExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected FinalVersionSoSaDocData CurrentFinalVersionSoSaDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as FinalVersionSoSaDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected FinalVersionSoSaDocView CurrentFinalVersionSoSaDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as FinalVersionSoSaDocView;
			}
		}
		...
		/// </summary>
		protected FinalVersionSoSaExplorerToolWindow FinalVersionSoSaExplorerToolWindow
		{
			get
			{
				FinalVersionSoSaExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(FinalVersionSoSaExplorerToolWindow), true) as FinalVersionSoSaExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				FinalVersionSoSaExplorerToolWindow explorerWindow = this.FinalVersionSoSaExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class FinalVersionSoSaClipboardCommandSet : FinalVersionSoSaClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new FinalVersionSoSaClipboardCommandSet.
		/// </summary>
		public FinalVersionSoSaClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class FinalVersionSoSaClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new FinalVersionSoSaClipboardCommandSetBase.
		/// </summary>
		protected FinalVersionSoSaClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
