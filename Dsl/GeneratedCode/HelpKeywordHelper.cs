...
namespace Company.FinalVersionSoSa
{
	...
	/// </remarks>
	public partial class FinalVersionSoSaHelpKeywordHelper : FinalVersionSoSaHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new FinalVersionSoSaHelpKeywordHelper.
		/// </summary>
		protected FinalVersionSoSaHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the FinalVersionSoSaHelpKeywordHelper.
		/// </summary>
		public static FinalVersionSoSaHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class FinalVersionSoSaHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new FinalVersionSoSaHelpKeywordHelperBase.
		/// </summary>
		protected FinalVersionSoSaHelpKeywordHelperBase()
			: base() { }
